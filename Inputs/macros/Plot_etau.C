...
void Plot_etau( bool embedded = false,
  ...
  TString DataFile = "SingleElectron_Run2017";
  if (era=="2018")
    DataFile = "EGamma_Run2018";
  if (era=="2016")
    DataFile = "SingleElectron_Run2016";
  ...
  TString CutsZTT_OS  = CutsOS + TString("&&gen_match_1==3&&gen_match_2==5");
  TString CutsZLL_OS  = CutsOS + TString("&&!(gen_match_1==3&&gen_match_2==5)");
  TString CutsZTT_SS  = CutsSS + TString("&&gen_match_1==3&&gen_match_2==5");
  ...
  if (era=="2016") {
    sampleNames[1] = TString("TT");
    sampleNames[2] = TString("TT");
    sampleNames[3] = TString("TT");
    
  }
  if (embedded) {
    sampleNames[21] = TString("EmbeddedElTau_Run2018");
    if (era=="2017")
      sampleNames[21] = TString("EmbeddedElTau_Run2017");
    if (era=="2016")
      sampleNames[21] = TString("EmbeddedElTau_Run2016");
  }
